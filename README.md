...
$param2 : The desired module view file to generate the content for the template views. Use the veiw filename without "_view.php". The default view file modules/module_name/module_name_view.php of the calling module will be used if the parameter is not specified.
